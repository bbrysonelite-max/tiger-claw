...
ENCRYPTION_KEY="${ENCRYPTION_KEY:-d12231134357ba94a7abfbf546ffef4142d46a1f0dcdf45f168ec225e6b17ee8}"
SERPER_KEY_1="${SERPER_KEY_1:-4852df01cf46f162ce171b24b5c1a8b72987fdda}"
SERPER_KEY_2="${SERPER_KEY_2:-85448f5ff632c5afd03f901875a056860e4f9632}"
SERPER_KEY_3="${SERPER_KEY_3:-8868f05919469495c408c995ead68e330e3d88f7}"
TIGER_CLAW_API_URL="${TIGER_CLAW_API_URL:-http://host.docker.internal:4000}"
DATABASE_URL="postgresql://botcraft:chatwoot123@host.docker.internal:5432/tiger_bot"
